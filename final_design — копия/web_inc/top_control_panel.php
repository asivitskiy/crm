<div class="header_wrapper_showlist">
    ...
    echo "<a href=?&myorder=0&noready=1&showlist=&delivery=1&manager=current ";
    ...
    foreach($button_type as $key_out => $value_out){
        ...
        if ((
            ...
            ?>
            <script>document.location.href = '?&myorder=0&noready=1&showlist=&delivery=1&manager=current'; </script>
            <?
        }
