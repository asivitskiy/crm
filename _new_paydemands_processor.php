...
$paylist_demand_date_for_sql = dig_to_d($paylist_demand_date).'.'.dig_to_m($paylist_demand_date).'.'.dig_to_y($paylist_demand_date);
...
$paylist_demand_number_for_sql = $paylist_demand_number.' от '.$paylist_demand_date_for_sql;
