...
<style id="Ю-0809 Тропина тетр А4_6347_Styles">
	body {
		font-family: dompdf_tahoma, Tahoma;
		font-weight: 800;
	}
	.c {
		font-family: dompdf_tahoma, Consolas, "Andale Mono", "Lucida Console", "Lucida Sans Typewriter", Monaco, "Courier New", "monospace";
		height: 18px;
...
.xl656347
	...
	font-family: dompdf_tahoma,Arial, sans-serif;
...
.xl696347
	...
	font-style:normal;
	text-decoration:none;
	font-family: dompdf_tahoma,Tahoma, sans-serif;
	mso-font-charset:204;
	mso-number-format:General;
	text-align:general;
	vertical-align:bottom;
...
.xl1116347
	...
	font-style:normal;
	text-decoration:none;
	font-family: dompdf_tahoma,"Arial Cyr";
	mso-generic-font-family: dompdf_tahoma,auto;
	mso-font-charset:204;
	mso-number-format:General;
	text-align:left;
	vertical-align:middle;
