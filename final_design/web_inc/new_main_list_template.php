<div>
    ...
    if ($_GET['manager']== 'current') {$viewedmanager = $current_manager;}
    else {$viewedmanager = $_GET['manager'];}
	...
	LEFT JOIN `works` ON order.order_number = works.work_order_number";
        ...
        if (($_GET['myorder'])<>1) {$where_and=$where_and." and (order.order_manager = '$viewedmanager')";}
