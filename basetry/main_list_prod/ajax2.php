...
//формируем табличку с данными заказа ?>
    <div class="details_of_order ">
        ...
        <table class="table-order-details"  cellspacing="0" cellpadding="0">
            <tbody>
            <tr style="background-color: antiquewhite;">
                <th class="work-name">Название</th>
                <th >Техника</th>
                <th >Шир</th>
                <th >Выс</th>
                <th >Цвет</th>
            ...
            { ?>
                <tr class="order_details">
                    <td class="work-name"><b><? echo $sps_data['work_name']; ?></b><p><? echo $sps_data['work_description']; ?></p></td>
