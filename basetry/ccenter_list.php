...
<? $today_month = date("m"); ?>  
		...
		<div style="float: left;; display: inline;">
				...
				<?
			$query_cclist_1 = "SELECT * FROM `ccenter` WHERE `type` LIKE 'bnal' AND `date_m` ='$today_month' ORDER BY `id` DESC";
		...
		<div style="margin-left: 250px;">
				...
				<table class="simple-little-table">
				<?
			$query_cclist_2 = "SELECT * FROM `ccenter` WHERE `type` LIKE 'nal' AND `date_m` = '$today_month'  ORDER BY `id` DESC";
